...
```{r data4, echo=FALSE,message=FALSE, fig.cap="Gráfica de dispersión de variables pH y número total de bacterias presentes en el suelo muestreado."}
...
fit2 <- glance(fit1)
kable(fit2, digits = 2, caption = "Indicadores estadísticos de modelo propuesto (diversidad~pH)") %>% kable_styling(bootstrap_options = c("striped", 
    "hover", "condensed"))
```
